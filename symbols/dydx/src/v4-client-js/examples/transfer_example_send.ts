...
DYDX_TEST_MNEMONIC = "couch diesel grow mutual river dawn happy settle sword vanish husband wonder hotel pioneer grit impose sibling amount bottom must find jazz kitchen napkin"
...
async function test(): Promise<void> {
  ...
  const msgs: Promise<EncodeObject[]> = new Promise((resolve) => {
    const msg = client.post.composer.composeMsgSendToken(
      ...
      "dydx16qvapwy0estx0w3csrkljtpmm8n3kjw9dwjzmh",
